...
export class GetPostsDto {
  ...
  @IsOptional()
  @Matches(
    /^(apartment|house|villa|land|office|room|other)(,(apartment|house|villa|land|office|room|other))*$/,
  )
  @Type(() => String)
  ...
  @ApiProperty({
    description: 'Radius for location search in kilometers',
    example: 5,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description:
      'Boundary coordinates for area search [minLat, minLng, maxLat, maxLng]',
    required: false,
  })
  @IsOptional()
  @IsString()
